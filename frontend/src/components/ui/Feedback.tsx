...
export function ErrorState({ error, title, message, retry, action, headingLevel = 2 }: { error?: unknown; title?: string; message?: string; retry?: () => void; action?: ReactNode; headingLevel?: 1 | 2 }) {
